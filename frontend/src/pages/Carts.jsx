...
function Carts() {
  return (
    <div>
      ...
      >
        <div
          className="w-full flex justify-center transform translate-x-0 transition ease-in-out duration-700"
          id="checkout"
        >
          <div
          ...
          >
            ...
            <div className="lg:w-96 md:w-8/12 w-full lg:ml-14 bg-gray-100 dark:bg-gray-900 ">
